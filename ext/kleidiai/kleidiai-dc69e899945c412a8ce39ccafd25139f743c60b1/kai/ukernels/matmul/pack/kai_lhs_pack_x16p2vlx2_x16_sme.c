...
void kai_kernel_lhs_pack_x16p2vlx2_x16_sme(const KernelArgs* args_ptr);
...
void kai_run_lhs_pack_x16p2vlx2_x16_sme(
    ...
    for (size_t block_y = 0; block_y < m; block_y += block_height) {
        ...
        void* out = lhs_packed_ptr + block_y * kai_roundup(k, KR) * sizeof(uint16_t);
        ...
        kai_kernel_lhs_pack_x16p2vlx2_x16_sme(&args);
    }
}
