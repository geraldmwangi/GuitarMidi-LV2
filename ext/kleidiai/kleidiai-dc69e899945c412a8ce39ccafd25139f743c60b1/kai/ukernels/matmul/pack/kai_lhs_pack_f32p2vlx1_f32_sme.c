...
void kai_kernel_lhs_pack_f32p2vlx1_f32_sme(const KernelArgs* args_ptr);
...
void kai_run_lhs_pack_f32p2vlx1_f32_sme(
    ...
    for (size_t block_y = 0; block_y < m; block_y += block_height) {
        ...
        void* out = lhs_packed_ptr + block_y * kai_roundup(k, KR) * sizeof(float);
        ...
        kai_kernel_lhs_pack_f32p2vlx1_f32_sme(&args);
    }
}
