#!/bin/bash
set -e
# this script copies a random subset of files from the source directory to the target directory, while ensuring that files listed in usedrecords-electric-chordsmootheddist.txt are excluded. 
...
SOURCE_DIR="/data2/training_subset_electric/"
TARGET_DIR="/training_cache/training_subset_electric"
USEDRECORDS_FILE="usedrecords-electric-chordsmootheddist.txt"
