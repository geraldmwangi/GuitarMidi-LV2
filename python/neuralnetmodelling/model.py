...
def chord_conv_block(string_features, filters,output_dim,training, kernel_size=(6,4), name_prefix="chord"):
...
def build_1d_cnn_model(batch_sz=64, input_shape=(image_height, image_width),
    ...
    processed_strings = chord_conv_block(string_features,output_dim=N_FRETS,training=training, filters=64, kernel_size=(6,4), name_prefix="chord_block")
